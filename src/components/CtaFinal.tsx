    ...
    <section className={styles.section} id="contacto">
      ...
      <FadeIn className={styles.inner}>
        ...
        <h2 className={styles.title}>
          ¿Tu negocio tiene<br />
          <em>potencial online?</em>
        </h2>
        <p className={styles.sub}>
          Si creés que tu negocio merece tener web y nunca terminaste de dar el paso, 
          escribinos. Sin compromiso, sin formularios largos. Una charla directa.
        </p>
